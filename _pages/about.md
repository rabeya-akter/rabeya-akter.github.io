...
I am currently working as an **Associate Software Engineer, QA** at [Therap (BD) Ltd.](https://therapbd.com/), where I lead the quality assurance efforts for various Machine Learning systems implementation. 

Before joining here at Therap (BD) Ltd.,
- I worked under [Dr. Sejuti Rahman](https://www.du.ac.bd/index.php/faculty/faculty_details/RME/2150) as a **Undergraduate Research Assistant** and worked at the intersection of **Natural Language Processing** and **Computer Vision** to design and implement a novel architecture for Bangla Sign Language (BdSL) translation, setting the first benchmark in this field.
